            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <table>
                    <tr><td><b>Sale ID:</b></td><td><input type="text" style="width:60px" value="{{$sale->id}}"  readonly/></td></tr>
                    <tr><td><b>Sale Date:</b></td><td><input type="text" id="txtSaleDate" value="{{$sale->sale_date}}" /></td></tr>
                    <tr><td><b>Delivery Date:</b></td><td><input type="text" id="txtDueDate" value="{{$sale->delivery_date}}" /></td></tr>
                  </table>
                </div>
                <!-- /.col -->
              </div>
