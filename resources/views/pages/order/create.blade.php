...
<style>
 ...
 <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 style="color: #8c31ee; font-weight:900;"> Sale Processing</h3>
          </div>
          <div class="col-sm-6">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <table>
                    <tr><td><b>Sale ID:</b></td><td><input type="text" style="width:60px" value="<?php //echo Order::getLastOrderId()+1;?>"  readonly/></td></tr>
                    <tr><td><b>Sale Date:</b></td><td><input type="text" id="txtOrderDate" value=<?php echo date("d-m-Y");?> /></td></tr>
              ...
              <div class="row no-print">
                <div class="col-12">
                  ...
                  <button type="submit" id="btnProcessOrder" class="btn btn-success float-right"><i class="far fa-credit-card"></i> Process  </button>
